...
import com.rakeshpoc.schoolapp.repository.CoursesRepository;
import com.rakeshpoc.schoolapp.repository.EazyClassRepository;
...
public class AdminController {
    ...
    public ModelAndView deleteClass(Model model, @RequestParam int id){
        EazyClass eazyClass = eazyClassRepository.findById(id);
    ...
    public ModelAndView displayStudents(Model model, @RequestParam int classId, HttpSession session,
        ...
        Optional<EazyClass> eazyClass = Optional.ofNullable(eazyClassRepository.findById(classId));
